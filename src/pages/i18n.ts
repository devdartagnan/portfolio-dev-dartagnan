      ...
      pt: {
        translation: {
          ...
          home: {
            about: {
              title: 'Sobre',
              about: 'Meu nome é Leonardo. Sou um desenvolvedor front-end que adora tecnologia e arte em geral. Embora ainda não tenha nenhuma experiência em trabalho de desenvolvimento, tenho aprimorado minhas habilidades trabalhando em alguns projetos pessoais. Uma das coisas que adoro no desenvolvimento front-end é como ele me permite combinar meus interesses em arte e tecnologia. Vejo o desenvolvimento web como uma forma de entender melhor como o mundo digital começará a ser no futuro, pois a arte digital pode ser usada para criar experiências envolventes e imersivas para os usuários. Eu me esforço para criar ferramentas que não sejam apenas visualmente atraentes, mas também funcionais e fáceis de usar. Quando não estou codificando, geralmente estou explorando o exterior, jogando videogame ou participando de exposições de arte locais. Acho que esses hobbies me inspiram a pensar criativamente e abordar meu trabalho de diferentes ângulos. Obrigado por reservar um tempo para conferir meu portfólio e espero que goste de explorar meus designs tanto quanto eu gostei de criá-los.'
            },
            profile: {
